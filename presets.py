...
class Presets(object):
    ...
    WELCOME_TEXT = "Hello.. <b>{}</b>\n<code>I can helpyou getting moviesfrom</code><a href='https://t.me/malllumoviesgroups'>【﻿മല്ലു】𝕎𝕖𝕓²·⁰🎥</a> " \
                   "©ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ:@ivar_bonel" \
    ...
    MEDIA_SEND_TEXT = "<code>സാധനം ᴘᴍ ഇൽ ഉണ്ട് 🥳</code>"
